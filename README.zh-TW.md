...
- **全域熱鍵** — <kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>R</kbd>。
...
|---|---|
| **左鍵**點圖示 | 在兩個方向之間切換 |
| **右鍵** | 選單：四個角度、目標螢幕、位置與對齊、開機自動啟動 |
| <kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>R</kbd> | 等同左鍵 |
| 滑鼠停留 | 顯示螢幕名稱與目前方向 |
...
| `Hotkey` | 啟用 <kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>R</kbd> |
